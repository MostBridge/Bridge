...
2. [Подготовка к запуску](#start)
    ...
    2.2. [Настройка poetry](#poetry)

    2.3. [Настройка pre-commit](#pre-commit)

    2.4. [Настройка переменных окружения](#env)

3. [Запуск в Docker](#run-docker)

4. [Требования к тестам](#test)
...
## 2.1. Правила работы с git (как делать коммиты и pull request-ы)<a id="git"></a>:
...
## 2.2. Poetry (инструмент для работы с виртуальным окружением и сборки пакетов)<a id="poetry"></a>:
...
poetry update
```
## 2.3. Pre-commit (инструмент автоматического запуска различных проверок перед выполнением коммита)<a id="pre-commit"></a>:
...
## 3. Запуск проекта в Docker <a id="run-docker"></a>
...
# 4. Требования к тестам <a id="test-bot"></a>
